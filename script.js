...
const colorGold = new THREE.Color(0xffbe0b);
const colorYellow = new THREE.Color(0xffea00);
    ...
    certForm.addEventListener("submit", function(e) {
        ...
        setTimeout(() => {
            if(cedula === "1234567890") {
                resultado.innerHTML = `
                    <p><strong style="color:var(--gold);">Nombre:</strong> Usuario de Prueba</p>
                    <p><strong style="color:var(--gold);">Curso:</strong> Especialidad en Control de Calidad</p>
                    <p><strong style="color:var(--gold);">Fecha de expedición:</strong> 30 de abril de 2026</p>
                    <p style="color: #2ecc71; margin-top: 10px;">✅ Certificado Aprobado y Validado.</p>
                    <a href="#" class="card-btn btn-green" style="display:inline-block; margin-top:20px; padding:10px 20px; text-decoration:none; text-align:center;">DESCARGAR CERTIFICADO (PDF)</a>
                `;
            } else {
...
const bgPalette = ["#030303", "#0a0616", "#051411", "#020d1c", "#140505", "#030303"];
...
sections.forEach((sec, i) => {
    ScrollTrigger.create({
        ...
        onEnter: () => {
            gsap.to("body", { backgroundColor: bgPalette[i % bgPalette.length], duration: 1.5, ease: "power2.out" });
        },
        onEnterBack: () => {
            gsap.to("body", { backgroundColor: bgPalette[i % bgPalette.length], duration: 1.5, ease: "power2.out" });
        },
